      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12 lg:mb-16">
            <div className="bg-black bg-opacity-50 backdrop-blur-sm card-padding rounded-lg border border-gray-700">
              <TrendingDown className="w-8 h-8 text-oritech-red mb-4 mx-auto" />
              <h3 className="text-xl lg:text-2xl font-semibold text-white mb-3 lg:mb-4">Revenue Leakage</h3>
              <p className="text-gray-300 leading-relaxed">Manual processes cost you 20-40% more than automated solutions</p>
            </div>
            
            <div className="bg-black bg-opacity-50 backdrop-blur-sm card-padding rounded-lg border border-gray-700">
              <Clock className="w-8 h-8 text-oritech-red mb-4 mx-auto" />
              <h3 className="text-xl lg:text-2xl font-semibold text-white mb-3 lg:mb-4">Time Waste</h3>
              <p className="text-gray-300 leading-relaxed">Staff spend 60% of time on repetitive tasks that AI could handle</p>
            </div>
            
            <div className="bg-black bg-opacity-50 backdrop-blur-sm card-padding rounded-lg border border-gray-700">
              <Target className="w-8 h-8 text-oritech-red mb-4 mx-auto" />
              <h3 className="text-xl lg:text-2xl font-semibold text-white mb-3 lg:mb-4">Missed Opportunities</h3>
              <p className="text-gray-300 leading-relaxed">Lack of data insights prevents optimal decision making</p>
            </div>
          </div>
          <motion.button
